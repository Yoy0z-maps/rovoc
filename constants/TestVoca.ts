...
export const TEST_VOCABULARY: Word[] = [
  ...
  //       example: "Please keep your explanation concise.",
  //     },
  //   ],
  //   created_at: "2024-03-20",
  //   is_important: false,
  ...
  //       part: "adj",
  //       definition: "힘든, 고된",
  //       example: "The journey was arduous but rewarding.",
  //     },
  //   ],
  //   created_at: "2024-03-20",
  //   is_important: true,
  ...
  //       example: "He is a voracious reader, finishing several books a week.",
  //     },
  //   ],
  //   created_at: "2024-03-20",
  //   is_important: false,
